 ...
 * @author Alisson Dias
 */
public class TelaPacientesCadastrados extends javax.swing.JFrame {
   ...
   private void tblPacientesValueChanged(javax.swing.event.ListSelectionEvent evt) {                                          
      if (tblPacientes.getSelectedRow() != -1) {
       ...
       cmbSexo.setSelectedItem(sexoDoPaciente); 
          ...
          btnVerProntuario.setEnabled(true); // Habilita o botão
    } else {
        btnVerProntuario.setEnabled(false); // Desabilita o botão
    }
   ...
   private void carregarTabela() {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TelaPacientesCadastrados.class.getName());

    /**
     * Creates new form TelaCadastroFuncionario
     */
    public TelaPacientesCadastrados() {
        initComponents();
        
    cmbSexo.addItem("Masculino");
    cmbSexo.addItem("Feminino");
    cmbSexo.addItem("Outro");
    btnVerProntuario.setEnabled(false);
    ...
    private void initComponents() {
        ...
        btnVerProntuario = new javax.swing.JButton();
        ...
        btnVerProntuario.setText("Prontuario");
        btnVerProntuario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVerProntuarioActionPerformed(evt);
            }
        });
 ...
 // Coleta todos os dados da tela
  ...
  // Limpa todos os campos de texto
   ...
   // 1. Verifica se algum funcionário foi selecionado na tabela.
    ...
    private void btnVerProntuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerProntuarioActionPerformed
  int linhaSelecionada = tblPacientes.getSelectedRow();

    // Pega o ID e o Nome da linha selecionada na tabela
    int idPaciente = Integer.parseInt(tblPacientes.getValueAt(linhaSelecionada, 0).toString());
    String nomePaciente = tblPacientes.getValueAt(linhaSelecionada, 1).toString();

    // Cria a tela de prontuário, passando o ID e o nome do paciente para ela
    TelaProntuario telaProntuario = new TelaProntuario(idPaciente, nomePaciente);
    telaProntuario.setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_btnVerProntuarioActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new TelaPacientesCadastrados().setVisible(true));
    }
    ...
    private javax.swing.JButton btnVerProntuario;
